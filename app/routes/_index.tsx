...
export const meta: MetaFunction = () => {
  return [
    { title: "MadFox Bridge" },
    { name: "description", content: "Welcome to MadFox!" },
  ];
};
          ...
          <Listbox value={selected} onChange={setselected}>
            ...
            <div className="relative mt-2">
              <ListboxButton className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                ...
                dangerouslySetInnerHTML={{ __html: selected.avatar }} 
              />
                  <span className="ml-3 block truncate">{selected.chain}</span>
                </span>
                ...
                {chains.map((chain) => (
                  ...
                  >
                    <div className="flex items-center">
                      <span className="svg-icon"        dangerouslySetInnerHTML={{ __html: selected.avatar }} />
